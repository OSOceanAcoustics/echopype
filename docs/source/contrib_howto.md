...
:::{note}
We encourage all code contributions to be accompanied by tests and documentation (doctrings and inline comments).
...
3. Adjust the implementation to optimize the performance if necessary
