...
When ready to commit your changes, please run the pre-commit as that will run spell check,
and conversion to Sphix site for ReadTheDocs.
See `Jupyter Book <https://jupyterbook.org/en/stable/sphinx/index.html#convert-your-jupyter-book-into-a-sphinx-website>`_ for more details on this.
