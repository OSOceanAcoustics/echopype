...
@pytest.mark.parametrize(
    ...
    [
        # AZFP
        ("AZFP", "AZFP", "17082117.01A", "17041823.XML", {"salinity": 30, "pressure": 10}, {}, None, None),  # noqa: E501
        # EK60
...
def test_range_dimensions(
    ...
    if xml_file is not None:
        ...
        ed = ep.open_raw(raw_file=test_path[test_path_key] / raw_file, sonar_model=sonar_model)  # noqa: E501
