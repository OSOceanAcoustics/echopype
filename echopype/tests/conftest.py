...
if os.getenv("USE_POOCH") == "True" and os.getenv("PYTEST_XDIST_WORKER") is None:
    ...
    registry = {
        ...
        "ek80.zip": "sha256:b04cd5305cea1823045740fe13ae4f12bf2982c0f8614c9871e0d1dcc4b28fd3",
        ...
        "ek80_ext.zip": "sha256:9261b451412465774a6653969a19ae8d6cf17e346ec23c6cadde285c76b4d7b4",
